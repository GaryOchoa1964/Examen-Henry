...
while True:
    if tope == 0:
        break
    try:
        numero = int(input("Escriba el numero divisor o 0-Salir:"))
    except ValueError:
        print ("Debes escribir un numero o 0-Salir")
        continue
    if numero < 0:
        ...
        while verdadero == True:
            try:
                tope = int(input("Escriba numero tope o 0-Salir: "))
            except ValueError:
                print ("Debes escribir un numero o 0-Salir")
                continue
            if tope < 0:
...
while True:
    if exponente == 0:
        break
    try:
        numero = int(input("Escriba el NUMERO BASE o 0-Salir: "))
    except ValueError:
        print ("Debes escribir un numero o 0-Salir")
        continue
    if numero < 0:
        ...
        while verdadero == True:
            try:
                exponente = int(input("Escriba NUMERO EXPONENCIAL o 0-Salir: "))
            except ValueError:
                print ("Debes escribir un numero o 0-Salir")
                continue
            if exponente < 0:
                ...
                verdadero = False
    var_1 = numero**exponente
    print (numero,"a la potencia",exponente,"es igua a", var_1)
...
lista5=[3]
lista6=[4]
lista7=[lista1,lista5]
listalistas=[lista1,lista2,lista3]
print (lista1,lista2,lista3)
print (lista1+lista2+lista3)
print (lista7,lista6)
print (lista1+lista5+lista6)
valor=(len(listalistas))

while True:
    try:
        indice = int(input("Escriba el NUMERO INDICE o 0-Salir: "))
    except ValueError:
        print ("Debes escribir un numero o 0-Salir")
        continue
    if indice < 0:
        ...
        break
    if indice <= valor:
        print (listalistas[indice-1])
    else:
        print ("El indice", indice,"ES NULLO")
...
while True:
    try:
        variable = (input("Escriba el NUMERO FACTORIAL S-Salir: "))
        var_1 = int(variable)
    except ValueError:
        print ("Debes escribir un numero o S-Salir")
        if str(variable) == "S" or variable =="s":
           break
        else:
            continue
    if var_1 < 0:
        print("FACTORIAL DE:",var_1,"ES NULO")
        continue
    elif var_1 == 0:
        print("FACTORIAL DE:", var_1,"ES: 1")
        continue
    else:
        var_3 = var_1
        var_2 = 1
        while var_1 != 0:
            var_2 = var_2*var_1
            var_1 -= 1
        print("El factorial de",var_3, "es", var_2)
        print ("Factorial de",var_3,"es", factorial(var_3))
...
while True:
    if salida == 0:
        break
    try:
        desde = int(input("Escriba numero DESDE o 0-Salir: "))
    except ValueError:
        print ("Debes escribir un ENTERO o 0-Salir")
        continue
    if desde < 0:
        print("Debes escribir un número positivo.")
        continue
        ...
        while verdadero == True:
            try:
                hasta = int(input("Escriba numero HASTA: "))
            except ValueError:
                print ("Debes escribir un numero o 0-Salir")
                continue
            if hasta < 0:
...
dicc = {k:sorted(v) for k, v in dicc.items()}
print (dicc)

dicc = dict(sorted(dicc.items(), key=itemgetter(0),reverse=True))
print (dicc)
